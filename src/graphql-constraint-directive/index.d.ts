import {type GraphQLSchema, type GraphQLError, type DocumentNode, type ValidationContext} from "graphql";
import {type OperationDefinitionNode, type FragmentDefinitionNode, type InlineFragmentNode, type FieldNode, type ArgumentNode} from 'graphql/language';
 ...
 */
export function validateQuery () : (schema: GraphQLSchema, query: DocumentNode, variables: Record<string, any>, operationName?: string, pluginOptions?: {}) => GraphQLError[];
 ...
 */
export function createQueryValidationRule( options: Record<string, any>) : (context: ValidationContext) => QueryValidationVisitor;
